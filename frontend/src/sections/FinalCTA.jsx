    ...
    <div
      ...
      <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0 text-center">
        <h1
          ...
          Discover LearnSphere <br /> Your Path to Smarter Learning.
        </h1>
        <p
          className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
          Join thousands of learners transforming their education with personalized AI-driven courses and interactive tools designed to boost your skills and confidence.
        </p>
        <button type="button" class="py-2.5 px-5 me-2 mb-2 font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 mt-10 w-50 h-15 text-md items-center cursor-pointer">Get Started with LearnSphere</button>
      </div>
    </div>
  );
}
